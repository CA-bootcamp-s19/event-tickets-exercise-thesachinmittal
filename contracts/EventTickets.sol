...
contract EventTickets {
    ...
    */
    ...
    modifier isOwner{
        require(owner == msg.sender,'Address is not the owner');
    _;
    }
    /*
...
function buyTickets(uint tickets) public payable {
    ...
    require(msg.value >= tickets*TICKET_PRICE, ' not enough Funds');
    require(myEvent.totalTickets >= tickets, 'not enough tickets');
...
function getRefund() public payable{
    ...
    require(tickets!=0, "You have't purchase tickets yet");
